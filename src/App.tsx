...
export default function App() {
  ...
  const generateBotResponse = (userMessage: string): string => {
    const responses = [
      ...
      'That\'s a wonderful thought! I appreciate you sharing.',
      'Fascinating! I\'d love to explore this topic more with you.',
    ];
    ...
    <div className="relative min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col h-screen max-w-5xl mx-auto p-4 md:p-8">
        ...
        <motion.div
          ...
          className="flex-1 backdrop-blur-xl bg-white/5 rounded-3xl border border-white/10 shadow-2xl overflow-hidden flex flex-col"
        >
          {/* Messages area */}
            ...
            <div className="flex gap-3">
              ...
              >
                <Button
                  ...
                  className="h-full px-8 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white rounded-2xl shadow-lg shadow-purple-500/50 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                >
        ...
        <motion.div
          ...
          className="mt-4 text-center text-purple-200/50 text-sm"
        >
